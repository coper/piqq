...
#define BUTTON_WIDTH                            kScreenWidth - 60
//#define BUTTON_WIDTH                          300
#define BUTTONTITLE_FONT                        [UIFont fontWithName:@"FZLTXHK" size:20]
#define BUTTON_BORDER_WIDTH                     0.1f
...
#define TITLE_FONT                              [UIFont fontWithName:@"FZLTXHK" size:15]
...
- (void)creatButtonsWithTitle:(NSString *)title cancelButtonTitle:(NSString *)cancelButtonTitle destructionButtonTitle:(NSString *)destructiveButtonTitle otherButtonTitles:(NSArray *)otherButtonTitlesArray
{
    ...
    #pragma mark 设置字体
                   // [otherButton.titleLabel setFont:<#(UIFont *)#>];
                    [otherButton setTitleColor:[UIColor whiteColor] forState:UIControlStateNormal];
                    [otherButton setBackgroundColor:                    [self hexStringToColor:@"#fa4f51"]];
    ...
    if (cancelButtonTitle) {
        ...
        [cancelButton setBackgroundColor:                    [self hexStringToColor:@"#fa4f51"]];
...
//    UIButton *otherButton = [[UIButton alloc] initWithFrame:CGRectMake(BUTTON_INTERVAL_WIDTH, BUTTON_INTERVAL_HEIGHT + (postionIndex*(BUTTON_HEIGHT+(BUTTON_INTERVAL_HEIGHT/2))), BUTTON_WIDTH, BUTTON_HEIGHT)];
    ...
    UIButton *otherButton = [[UIButton alloc] initWithFrame:CGRectMake(BUTTON_INTERVAL_WIDTH, (postionIndex*(BUTTON_HEIGHT)+20), BUTTON_WIDTH, BUTTON_HEIGHT)];
